...
const fetchDataFromApi = async () => {
  try {
    const response = await axios.get(`${API_URL}/operation/131/${formattedDate}`);
...
export { nombreRejCRA131, rejetAccepteListLastSixDays, nombreRejCRA};
