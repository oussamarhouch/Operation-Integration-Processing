...
public class ReaderCRA implements ItemReader<String> {

    private final Iterator<String> fileIterator;
    protected final Logger logger;


    public ReaderCRA(String inputDirectoryPath) throws IOException {
        this.logger = LogManager.getLogger(getClass());

        String directoryPath = inputDirectoryPath + "/CRA";
        String filePattern = "*.CRA";
