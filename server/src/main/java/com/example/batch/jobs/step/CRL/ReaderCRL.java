...
public class ReaderCRL implements ItemReader<String> {

    private final Iterator<String> fileIterator;
    protected final Logger logger;

    public ReaderCRL(String inputDirectoryPath) throws IOException {
        this.logger = LogManager.getLogger(getClass());

        String directoryPath = inputDirectoryPath + "/CRL";
