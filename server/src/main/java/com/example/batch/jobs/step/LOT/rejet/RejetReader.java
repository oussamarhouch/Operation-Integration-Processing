...
public abstract class RejetReader implements ItemReader<String> {

    private final Iterator<String> fileIterator;
    protected final Logger logger;

    public RejetReader(String filePattern, String directoryPath) throws IOException {
        ...
        Resource[] resource = resolver.getResources("file:" + directoryPath + "/LOT/" + filePattern);
